...
public class FilmDbStorage implements FilmStorage{
    ...
    public Film addFilm(Film film) {
        ...
        if(film.getGenres() != null){
            for(Genre genre:film.getGenres()){
                String sqlQueryForGenre = "INSERT INTO genres_for_films VALUES (?, ?)";
                jdbcTemplate.update(sqlQueryForGenre,id,genre.getId());
            }
        }
    ...
    public Film updateFilm(Film film) {
        String sqlQuery = "UPDATE films SET name = ?, description = ?, mpa = ?, release_date = ?, duration = ? " +
            ...
            if(film.getGenres() != null){
                for(Genre genre:film.getGenres()){
                    String sqlQueryForGenre = "MERGE INTO genres_for_films key(id_film,id_genre)VALUES (?, ?) ";
